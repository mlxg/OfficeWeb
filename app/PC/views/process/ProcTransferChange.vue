<template>
    <component :is="currentView" :business-key="businessKey" :task-id="taskId" :human-task-id="id" :taskform-Key="taskFormKey" ></component>
    <Public-Modal :options="options" :confirm="confirm" :cancel="cancel" :close="close"></Public-Modal>
</template>
<script>
    import Approve from './ProcMyChange.vue'
    import Update from '../hrManage/HrChange.vue'
    ...
    asyncData: function (resolve, reject) {
        ...
        this.$http.post(content.STAROFFICE_ACT + interfaces.INTERFACE_GETTASKFORMBYID, {
            ...
            resolve({
                currentView: result.taskFormKey !== 'move_initiator_edit' ? 'Approve' : 'Update'
            })
        })
    }
    }
