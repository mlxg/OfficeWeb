...
<template>
    ...
    <!-- 部门建议-可以编辑-->
    <Tip-border tip="部门建议" v-if="!isShowFormalSalary">
    ...
    <Tip-border tip="人事部确定" v-if="!isShowFormalSalary">
        <div class="g-marginT20 g-marginB20 clearfix">
    ...
    <div class="showListBtn" v-if="this.humanTaskId != 0" @click='isShowCopiesListFun' >{{isShowCopiesText}}</div>
        ...
        methods: {
            ...
            loadData: function () {
                ...
                this.$http.post(content.CONTENT_ROOT + interfaces.INTERFACE_FINDAPPLICATION,{id:this.businessKey}).then(function (response) {
                    ...
                    that.isShowFormalSalaryFun(Data.employeeNatureId)
                    that.datas = Data;
                })
            },
            //删除流程
