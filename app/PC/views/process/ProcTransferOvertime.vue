<template>
    <component :is="currentView" :business-key="businessKey" :task-id="taskId" :human-task-id="id" :taskform-Key="taskFormKey" :hr="_hr" :deptheader="_deptheader" :kqgly="_kqgly" :zc="_zc" :zjl="_zjl" :edit="_edit" ></component>
    <Public-Modal :options="options" :confirm="confirm" :cancel="cancel" :close="close"></Public-Modal>
</template>
<script>
    import Approve from './ProcMyOvertime'
    import Update from '../hrManage/HrOvertime'
    ...
    asyncData: function (resolve, reject) {
        ...
        this.$http.post(content.STAROFFICE_ACT + interfaces.INTERFACE_GETTASKFORMBYID, {
            ...
            if(response.json().status == '0'){
              ...
              vm._kqgly = result.taskFormKey.search(/_kqgly/g)
