<template>
    <component :is="currentView" :business-key="businessKey" :task-id="taskId" :human-task-id="id" :cn="cn"></component>
    <Public-Modal :options="options" :confirm="confirm" :cancel="cancel" :close="close"></Public-Modal>
</template>
<script>
    import Approve from './ProcLoan.vue'
    import Update from '../Fina/Loan.vue'
    ...
    asyncData: function (resolve, reject) {
        ...
        this.$http.post(content.STAROFFICE_ACT + interfaces.INTERFACE_GETTASKFORMBYID, {
            ...
            let result = response.json().result;
              vm.cn = result.taskFormKey.search(/_cn/g)
