<template>
    <h2 class="g-tc u-fs20 g-marginB20">{{businessTitle}}</h2>
        ...
        <Tip-border tip="人员资料">
          ...
          <div class="form-group clearfix">
            ...
            <div class="col-sm-4" v-validate-class>
              <Tool-Selection :select-type-index="0" :all-select-types="type" v-model="post.maritalStatusId" v-validate:marriage="['required']"></Tool-Selection>
              <span class="fc-red" v-show="($base.marriage.touched || validating) && $base.marriage.required">请选择婚姻状况</span>
            </div>
          </div>
          ...
          <div class="form-group clearfix">
            ...
            <div class="col-sm-4" v-validate-class>
                ...
                <!-- <input type="text" class="form-control" v-model="post.socialSecurityNo" placeholder="" v-validate:securityno="{required: true, maxlength: 20 }"> -->
                <!-- <span class="fc-red" v-show="($base.securityno.touched || validating) && $base.securityno.required">必填项</span> -->
            ...
            <div class="col-sm-4" v-validate-class>
                <input type="text" class="form-control" v-model="post.socialSecuritySource" placeholder="" v-validate:insuredplace="{validate_insuredPlace:true}">
                <!-- <input type="text" class="form-control" v-model="post.socialSecuritySource" placeholder="" v-validate:insuredplace="{required: true, validate_insuredPlace:true}"> -->
                <!-- <span class="fc-red" v-show="($base.insuredplace.touched || validating) && $base.insuredplace.required">必填项</span> -->
          ...
          <div class="form-group clearfix">
            <label for="" class="col-sm-2 control-label field-require">户口性质：</label>
            <div class="col-sm-4" v-validate-class>
              <Tool-Selection :select-type-index="2" :all-select-types="type" v-model="post.familyId" v-validate:originnature="['required']"></Tool-Selection>
                <span class="fc-red" v-show="($base.originnature.touched || validating) && $base.originnature.required">请填写民族信息</span>
            </div>
        ...
        <validator name="ecp">
          ...
          <div class="form-group clearfix">
            ...
            <div class="col-sm-4" v-validate-class>
                <input type="text" class="form-control" v-model="employeeContacts.contactsYears" placeholder="" v-validate:ecpyears="{required:true, maxlength: 2}">
                <span class="fc-red" v-show="($ecp.ecpyears.touched || validating) && $ecp.ecpyears.required && addAgain_ecp">必填项</span>
                <span class="fc-red" v-show="($ecp.ecpyears.touched || validating) && $ecp.ecpyears.maxlength && addAgain_ecp">认识年限不得超过2位字符</span>
            </div>
          </div>
          <div class="form-group g-marginB20 clearfix">
              <label for="" class="col-sm-2 control-label field-require">地址：</label>
              <div class="col-sm-10" v-validate-class>
                  <!-- <textarea class="form-control" rows="3" v-model="employeeContacts.contactsAddress"></textarea> -->
        ...
        <Tip-border tip="家庭成员">
          ...
          <div class="form-group g-marginB20 clearfix">
              ...
              <div class="col-sm-10" v-validate-class>
                  <!-- <textarea class="form-control" rows="3" v-model="employeeFamily.address"></textarea> -->
    ...
    <div class="form-group g-tc g-marginT20">
        <button type="button" class="btn btn-default g-marginR30" v-if="!businessKey" @click="save">保存草稿</button>
      ...
      switch (idcard.length) {
          ...
          if(this.businessKey){
            ...
            this.$http.post(content.CONTENT_ROOT + interfaces.INTERFACE_GETEMPLOYEEENTRY, {id: this.businessKey}).then((response) => {
                ...
                resolve({
                  ...
                  'post.cardNoSource': result.cardNoSource,//身份证地址
        ...
        methods: {
            ...
            saveEmployee: function(){ // 存储以前雇主 employeeLeaveEmployer
              ...
              let salary = parseInt(vm.employeeLeaveEmployer.salary)
              vm.employeeLeaveEmployer.salary = isNaN(salary)?0:salary
