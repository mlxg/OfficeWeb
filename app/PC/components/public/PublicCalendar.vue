...
<script>
    ...
    methods: {
        ...
        select(k1, k2, e) {
            ...
            if (this.range) {
                if (this.rangeBegin.length == 0 || this.rangeEndTemp != 0) {
                    this.rangeBegin = [this.year, this.month, this.days[k1][k2].day, this.hour, this.minute]
                    this.rangeBeginTemp = this.rangeBegin
                    this.rangeEnd = [this.year, this.month, this.days[k1][k2].day, this.hour, this.minute]
                    this.rangeEndTemp = 0
                } else {
                    this.rangeEnd = [this.year, this.month, this.days[k1][k2].day, this.hour, this.minute]
                    this.rangeEndTemp = 1
        ...
        output(args) {
            if (this.type == 'time') {
                return this.zero(args[3]) + ":" + this.zero(args[4])
            }
