<style>
    .sliding-screen-transition { transition: right .5s ease; height: 100%;width: 50%;right: 0; position: fixed;  top:60px; background-color: white; box-shadow: 0 7px 21px rgba(0,0,0,.15);-moz-box-shadow: 0 7px 21px rgba(0,0,0,.15);-o-box-shadow:0 7px 21px rgba(0,0,0,.15);opacity: .95; }
