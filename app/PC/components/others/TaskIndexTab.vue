<style>
    ...
    .m-conter ul.p-list li {width: 270px;height: 134px; border: 1px solid #DDD; float: left;margin-left: 30px;margin-bottom:30px;border-radius: 10px;cursor: pointer;position: relative;background-color: #4aa5f9;transition: all ease-in .1s;}
    ...
    .m-conter ul.p-list li.p-card em {position: absolute;right: -5px;top: -5px;height: 20px;width: 20px;background-color: red; border-radius: 20px;}
...
<template>
    ...
    <Public-loading v-if="!taskIndexGetProjLst"></Public-loading>
